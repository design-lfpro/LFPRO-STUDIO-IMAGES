...
url: https://lfpro.com.br/products/sculpt-brow-medium
...
```
Beauty portrait of a medium-skinned model touching/framing her eyebrow, well-groomed sculpted brows, holding LF PRO Sculpt Brow Medium pencil near her face or resting in frame, exact pencil shape and gold logo from reference, premium neutral studio background, soft directional beauty light, photorealistic, no redesign
```
...
- Modelo: `sculpt-brow-modelo-medium` (Magnific library id 2151475)
