...
Lapiseira retrátil de ponta chanfrada para sobrancelhas, tom **Medium** (marrom médio, subtom frio). Ideal para fios castanho médio, morenos e de médio contraste.
...
- Faixa/anel de cor medium (marrom médio acinzentado) acima da base
- Ponta chanfrada marrom média, mecanismo de rosca visível
...
| Faixa de tom / ponta / swatch | Marrom médio, subtom frio |

## Textura / fórmula visível

Traço em curva (scribble) matte-cremoso, alta densidade mesmo em linha fina; cor marrom média consistente com a ponta.
...
### Still lock
```
Exact LF PRO Sculpt Brow Medium retractable brow pencil. Slim glossy black cylindrical
body, gold vertical wordmark "SCULPT BROW", gold LF monogram near base, medium grayish
brown (cool undertone) shade ring band above the base, angled bevel tip in medium brown,
...
### Studio hero (T1)
```
9:16 luxury cosmetics hero shot, LF PRO Sculpt Brow Medium retractable pencil standing
upright on a warm nude/beige studio surface, soft dramatic contact shadow, cap resting
beside it, subtle medium brown scribble swatch stroke in the background, gold lettering
...
### Texture macro (T2)
```
Macro shot of a medium grayish brown brow pencil scribble stroke, matte-creamy pigment
...
- Não alterar o tom Medium para outra cor
...
- Ideal para fios castanho médio, morenos e de médio contraste

## Notas para pipeline V1

- Âncora: `assets/products/sculpt-brow-medium/01.png` (identity lock, sem swatch)
