...
Lapiseira retrátil de sobrancelha tom **Medium** — marrom médio, subtom frio. Mesma embalagem da família; diferencia-se pela cor do grafite/ponta.

- Handle previsto: `sculpt-brow-medium` (a confirmar contra o site após o lançamento de 13/08)
- Indicação oficial: fios castanho médio, morenos e de médio contraste
...
`assets/cast/sculpt-brow-modelo-medium/` — modelo IA (ver `meta.yaml`, aprovada para esta campanha em 2026-08-10).

## Claims oficiais

Ver claims completos da família em `_family.md` — o Medium não tem claim exclusivo além do tom/indicação de uso.
