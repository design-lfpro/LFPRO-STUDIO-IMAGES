...
- **Packshot local + hex reais:** publicados a partir da pasta do Drive do usuário (`FOTO PRODUTO`, arquivos `SCULPT BROW {TOM} PRODUTO.png`) — ver `assets/products/sculpt-brow-{light,medium,dark}/01.png`
...
## Tons — Light, Medium, Dark

Packshot oficial isolado por tom, publicado em `assets/products/sculpt-brow-{tom}/01.png` (fonte: Drive, pasta FOTO PRODUTO, arquivos `SCULPT BROW {TOM} PRODUTO.png`). Hex extraído por amostragem de pixel da ponta chanfrada + faixa colorida no corpo:

| Tom | Hex aprox. | Leitura visual |
|-----|------------|-----------------|
| **Light** | `#6E5945` | castanho médio-claro quente |
| **Medium** | `#655C5A` | castanho acinzentado / taupe |
| **Dark** | `#454244` | grafite-marrom escuro |
...
- Produto com strokes/swatch (3 tons juntos): https://www.magnific.com/app/creation/huEMD6fvqL
- Produto still (fundo bege, "diversas"): https://www.magnific.com/app/creation/xSgF2ptjfW — legenda automática leu o monograma **LF** como "JC" por engano; é o logo normal da marca
