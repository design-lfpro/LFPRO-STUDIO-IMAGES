...
url: "https://lfpro.com.br/products/sculpt-brow-light"
...
Sculpt Brow tom **Light**. Mesma embalagem da família (corpo preto + wordmark vertical gold + ponta chanfrada); diferencia-se pela **cor da mina** e pela faixa indicadora de tom no corpo.

- Handle Shopify (previsto): `sculpt-brow-light`
...
| Cor da mina | Marrom claro, subtom frio. |
| Uso indicado | Ideal para fios loiros, castanho claro, ruivos e de baixo contraste. |
...
Este SKU = **Light**. Não misturar cor de mina de outro handle.
...
```
Exact LF PRO Sculpt Brow retractable eyebrow pencil shade Light, match reference image
packaging 1:1, matte black barrel with vertical gold SCULPT BROW wordmark and small gold
LF monogram, angled chiseled tip with light brown lead exposed, matching glossy
...
```
LF PRO Sculpt Brow Light exact packaging from reference on dark charcoal beauty studio
backdrop, soft key + gold rim light, product hero 3/4, micro push-in, 9:16, light
...
```
Macro chiseled brow pencil tip texture, light brown lead, fine matte hair-stroke
...
- Reference obrigatória: `assets/products/sculpt-brow-light/01.png`
