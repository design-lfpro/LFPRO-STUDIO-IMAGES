...
```
Beauty portrait of a light-skinned model touching/framing her eyebrow, well-groomed sculpted brows, holding LF PRO Sculpt Brow Light pencil near her face or resting in frame, exact pencil shape and gold logo from reference, premium neutral studio background, soft directional beauty light, photorealistic, no redesign
```
...
- Modelo: `sculpt-brow-modelo-light` (Magnific library id 2151468)
