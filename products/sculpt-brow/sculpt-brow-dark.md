...
Lapiseira retrátil de ponta chanfrada para sobrancelhas, tom **Dark** (marrom profundo acinzentado, subtom frio). Ideal para fios castanho escuro, pretos e de alto contraste.
...
- Faixa/anel de cor dark (marrom profundo acinzentado, quase preto) acima da base
- Ponta chanfrada marrom escura, mecanismo de rosca visível
...
| Faixa de tom / ponta / swatch | Marrom profundo acinzentado, subtom frio |

## Textura / fórmula visível

Traço em curva (scribble) matte-cremoso, alta densidade mesmo em linha fina; cor marrom escura acinzentada consistente com a ponta.
...
### Still lock
```
Exact LF PRO Sculpt Brow Dark retractable brow pencil. Slim glossy black cylindrical
body, gold vertical wordmark "SCULPT BROW", gold LF monogram near base, deep grayish
brown (cool undertone, near-black) shade ring band above the base, angled bevel tip
in dark brown, visible twist mechanism below the tip. Short glossy black dome cap
beside the pencil. Off-white background, soft studio light. Photorealistic identity lock.
```

### Studio hero (T1)
```
9:16 luxury cosmetics hero shot, LF PRO Sculpt Brow Dark retractable pencil standing
upright on a warm nude/beige studio surface, soft dramatic contact shadow, cap resting
beside it, subtle deep brown scribble swatch stroke in the background, gold lettering
...
### Texture macro (T2)
```
Macro shot of a deep grayish brown brow pencil scribble stroke, matte-creamy pigment
texture, soft sheen, fine hair-like fiber lines visible, beauty advertising macro,
cool undertone.
```
...
- Não alterar o tom Dark para outra cor
...
- Ideal para fios castanho escuro, pretos e de alto contraste

## Notas para pipeline V1

- Âncora: `assets/products/sculpt-brow-dark/01.png` (identity lock, sem swatch)
