---
handle: classic-lips-amber
title: Classic Lips Amber
family: classic-lips
product_type: Batom
sku: "12701"
price: "69.90"
url: https://lfpro.com.br/products/classic-lips-amber
preferred_tracks: [T1-product-hero, T2-texture-macro]
blocked_tracks: [T5-face-proof]
status: dna-v1
assets_local: assets/products/classic-lips-amber/
shade: Amber
---
...
Batom Classic Lips tom **Amber**. Mesmo packaging black+gold da linha; diferencial exclusivo = cor da bala **Nude quente caramelo / soft bronze-beige, tom de pele bronzeada suave** (hex aprox. `#C48A6A / #B87858`).
...
2. Stick aberto à direita: base preta + coluna gold mirror + bullet na cor Amber com monograma LF embutido no topo
...
**Assets:** `assets/products/classic-lips-amber/01.webp` (hero), `02.png` (macro texture quando existir), `03+` on-lips/swatch.
...
Mais quente e amarronzado que Rose; menos rosado que Bloom; base nude essencial para combos Nude.

## Prompt anchors (EN)

### Still lock (packshot identity)
```
Exact LF PRO Classic Lips Amber lipstick packshot. Glossy black cap with gold LF monogram and gold "LF PRO" text, thin gold top rim. Open gold metallic barrel, black base. Creamy lipstick bullet shade Nude quente caramelo / soft bronze-beige, tom de pele bronzeada suave, color approx #C48A6A / #B87858, embossed LF monogram on bullet tip. Off-white #F7F5F2 background, soft studio light, soft shadow. Photorealistic e-commerce, identity lock, do not redesign packaging.
```

### Studio hero scene (T1)
```
9:16 luxury product hero. Classic Lips Amber (#C48A6A / #B87858) on deep black background with subtle gold accent light. Black glossy cap and gold barrel identity locked. Slow elegant float/orbit, specular highlights on gold metal, creamy Amber bullet visible. Premium cosmetics commercial, cinematic.
```

### Texture macro (T2)
```
Macro beauty shot: Classic Lips Amber bullet tip with embossed LF logo, gold collar below. Background thick creamy smear of same shade #C48A6A / #B87858. Buttery hydrating lipstick texture, rich pigment, soft sheen, no matte powder look. Photorealistic texture advertising.
```
