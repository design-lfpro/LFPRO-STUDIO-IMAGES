---
handle: classic-lips-rose
title: Classic Lips Rose
family: classic-lips
product_type: Batom
sku: "12700"
price: "69.90"
url: https://lfpro.com.br/products/classic-lips-rose
preferred_tracks: [T1-product-hero, T2-texture-macro]
blocked_tracks: [T5-face-proof]
status: dna-v1
assets_local: assets/products/classic-lips-rose/
shade: Rose
---
...
Batom Classic Lips tom **Rose**. Mesmo packaging black+gold da linha; diferencial exclusivo = cor da bala **Nude rosado claro / soft mauve-nude pink, tom natural de lábios rosados** (hex aprox. `#C99A96 / #C48B88`).
...
2. Stick aberto à direita: base preta + coluna gold mirror + bullet na cor Rose com monograma LF embutido no topo
...
**Assets:** `assets/products/classic-lips-rose/01.webp` (hero), `02.png` (macro texture quando existir), `03+` on-lips/swatch.
...
Mais claro e nude-rosado que Bloom; mais rosado que Amber. Base do combo Contorno Perfeito (catálogo).

## Prompt anchors (EN)

### Still lock (packshot identity)
```
Exact LF PRO Classic Lips Rose lipstick packshot. Glossy black cap with gold LF monogram and gold "LF PRO" text, thin gold top rim. Open gold metallic barrel, black base. Creamy lipstick bullet shade Nude rosado claro / soft mauve-nude pink, tom natural de lábios rosados, color approx #C99A96 / #C48B88, embossed LF monogram on bullet tip. Off-white #F7F5F2 background, soft studio light, soft shadow. Photorealistic e-commerce, identity lock, do not redesign packaging.
```

### Studio hero scene (T1)
```
9:16 luxury product hero. Classic Lips Rose (#C99A96 / #C48B88) on deep black background with subtle gold accent light. Black glossy cap and gold barrel identity locked. Slow elegant float/orbit, specular highlights on gold metal, creamy Rose bullet visible. Premium cosmetics commercial, cinematic.
```

### Texture macro (T2)
```
Macro beauty shot: Classic Lips Rose bullet tip with embossed LF logo, gold collar below. Background thick creamy smear of same shade #C99A96 / #C48B88. Buttery hydrating lipstick texture, rich pigment, soft sheen, no matte powder look. Photorealistic texture advertising.
```
