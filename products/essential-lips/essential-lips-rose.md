...
Batom líquido matte Essential Lips, tom **Rose** — rosa profundo tipo framboesa. Mesmo packaging da linha (ver [[_family|Essential Lips DNA]]); diferencial exclusivo = cor do líquido.

## Packaging (lock visual)

Ver `_family.md`. Lock:

1. Frasco em vidro/acrílico fosco translúcido, colunar, ombros retos — líquido Rose visível por trás do fosco
...
4. Aplicador doefoot preto com ponta em veludo/esponja afunilada, cor Rose
...
| Parte | Cor / hex aprox |
|-------|-------------------|
| Líquido / swatch Rose | rosa profundo tipo framboesa, aprox `#6B2138` |
...
- entre Blush e Malt em saturação; mais 'rosa puro' que os tons terrosos

## Notas para pipeline V1

- Packshot âncora: `assets/products/essential-lips-rose/01.jpeg`
