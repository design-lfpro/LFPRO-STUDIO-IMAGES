...
Essential Lips tom **Carmim**. Mesma embalagem da família (tubo translúcido + aplicador doe-foot + tampa preta); diferencia-se pela **cor do líquido** visível no tubo, na ponta do aplicador e no swatch.

- Handle Shopify (previsto): `essential-lips-carmim`
...
| Cor do produto | Tom vermelho intenso, quente, com fundo levemente alaranjado. |
| Hex aproximado (observado no packshot oficial) | `#C21F2C` |
...
Este SKU = **Carmim**. Não misturar cor de outro handle.
...
```
Exact LF PRO Essential Lips liquid lipstick shade Carmim, match reference image packaging 1:1,
frosted translucent tube with gold LF monogram and LF PRO lettering, glossy black cap,
doe-foot foam applicator tip saturated in color #C21F2C, wide lipstick swatch smear behind
product matching shade #C21F2C, pure white ecommerce cutout background, preserve logo, no redesign
```

### Studio hero scene (T1)

```
LF PRO Essential Lips Carmim exact packaging from reference on dark charcoal beauty studio
backdrop, soft key + gold rim light, product hero 3/4, micro push-in, 9:16, shade color
#C21F2C visible on applicator/swatch, logo sharp, no face no hands
```

### Texture macro (T2)

```
Macro glossy liquid lipstick smear texture color #C21F2C, soft matte setting finish, creamy
...
- Reference obrigatória: `assets/products/essential-lips-carmim/01.png`
