...
Batom líquido matte Essential Lips, tom **Clay**. Mesmo packaging da linha (ver [[_family|Essential Lips DNA]]); diferencial exclusivo = cor do líquido.

## ⚠️ Sem packshot oficial

Não há foto real deste SKU ainda em `assets/products/essential-lips-clay/`. Cor abaixo é **estimativa visual a partir do infográfico de lançamento**, não é leitura de packshot — precisa ser confirmada (ou corrigida) por Ana Produto assim que a foto oficial chegar. Não gerar still de entrega em identity lock até lá.

## Cor (provisória)

| Parte | Cor / hex aprox (provisório) |
|-------|-------------------------------|
| Líquido/swatch Clay | terracota/tijolo, tom quente alaranjado — não confundir com Malt (Malt é mais neutro/marrom), aprox `#A85248` |
...
- terracota/tijolo, tom quente alaranjado — não confundir com Malt (Malt é mais neutro/marrom)

## Notas para pipeline V1

- Aguardando `assets/products/essential-lips-clay/01.*` para lock de identidade
