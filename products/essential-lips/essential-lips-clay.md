...
url: "https://lfpro.com.br/products/essential-lips-clay"
...
shade: Clay
lipstick_hex_approx: "#8E3A34"
shopify_id: 10367202525464
shopify_sku: "12708"
price_brl: "69.90"
---
...
Essential Lips tom **Clay**. Mesma embalagem da família (tubo translúcido + aplicador doe-foot + tampa preta); diferencia-se pela **cor do líquido** visível no tubo, na ponta do aplicador e no swatch.

- Handle Shopify (previsto): `essential-lips-clay`
...
| Cor do produto | Tom terracota, quente, com toque avermelhado. |
| Hex aproximado (observado no packshot oficial) | `#8E3A34` |
...
Este SKU = **Clay**. Não misturar cor de outro handle.
...
```
Exact LF PRO Essential Lips liquid lipstick shade Clay, match reference image packaging 1:1,
frosted translucent tube with gold LF monogram and LF PRO lettering, glossy black cap,
doe-foot foam applicator tip saturated in color #8E3A34, wide lipstick swatch smear behind
product matching shade #8E3A34, pure white ecommerce cutout background, preserve logo, no redesign
```

### Studio hero scene (T1)

```
LF PRO Essential Lips Clay exact packaging from reference on dark charcoal beauty studio
backdrop, soft key + gold rim light, product hero 3/4, micro push-in, 9:16, shade color
#8E3A34 visible on applicator/swatch, logo sharp, no face no hands
```

### Texture macro (T2)

```
Macro glossy liquid lipstick smear texture color #8E3A34, soft matte setting finish, creamy
...
- Reference obrigatória: `assets/products/essential-lips-clay/01.png`
