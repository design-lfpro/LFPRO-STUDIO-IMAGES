...
2. **Tampa**: preta **glossy lisa**, cilíndrica, **SEM rosca/ranhura visível, sem textura de grip, sem nenhum detalhe ou friso** — superfície completamente lisa e brilhante; encaixa sobre o gargalo do frasco.
...
4. **Sem faixa/colarinho dourado** entre a tampa e o corpo — a transição tampa→vidro fosco é direta, sem stripe, sem anel, sem nenhum acabamento intermediário.

**Regra — NUNCA adicionar ranhura na tampa nem faixa/anel dourado (erro confirmado 03/09).** Comparação direta com foto real do Malt mostrou que a tampa é **lisa** (sem "fine horizontal grip ridges" que vínhamos descrevendo nos prompts) e **não existe** nenhuma faixa/trim dourado no encontro tampa-corpo (nem no cap, nem como colarinho no vidro — item 4 antigo estava errado e foi removido). Prompt de still de produto deve declarar explicitamente: *"the cap is a smooth, plain glossy black lacquer/plastic cylinder — no ridges, no grip texture, no gold trim ring or band anywhere on the cap or at the cap-to-body seam; the transition from cap to frosted glass body is a clean, direct line with no intermediate collar or stripe."*
