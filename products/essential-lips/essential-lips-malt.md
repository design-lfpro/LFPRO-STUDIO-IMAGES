...
Batom líquido matte Essential Lips, tom **Malt** — vermelho-rosado terroso. Mesmo packaging da linha (ver [[_family|Essential Lips DNA]]); diferencial exclusivo = cor do líquido.

## Packaging (lock visual)

Ver `_family.md`. Lock:

1. Frasco em vidro/acrílico fosco translúcido, colunar, ombros retos — líquido Malt visível por trás do fosco
...
4. Aplicador doefoot preto com ponta em veludo/esponja afunilada, cor Malt
5. Sem texto do nome do tom impresso no frasco

**Assets:** `assets/products/essential-lips-malt/01.jpeg` (still de estúdio — fundo cinza, ver aviso de fundo em `_family.md`).

## Cor

**Descrição oficial (fonte: Direcionamento Time Essential Lips):** Tom rosado terroso, quente. Com toque de marrom.

### Leitura aproximada do still de estúdio (hex direcional)

| Parte | Cor / hex aprox |
|-------|-------------------|
| Líquido / swatch Malt | vermelho-rosado terroso, aprox `#791A30` |
...
- entre Beige e Mauve; não confundir com Clay (Clay é mais fechado/vinho)

## Notas para pipeline V1

- Packshot âncora: `assets/products/essential-lips-malt/01.jpeg`
