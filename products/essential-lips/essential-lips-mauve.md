...
Essential Lips tom **Mauve**. Mesma embalagem da família (tubo translúcido + aplicador doe-foot + tampa preta); diferencia-se pela **cor do líquido** visível no tubo, na ponta do aplicador e no swatch.

- Handle Shopify (previsto): `essential-lips-mauve`
...
| Cor do produto | Tom malva, neutro a frio, com fundo levemente arroxeado. |
| Hex aproximado (observado no packshot oficial) | `#9B4A5E` |
...
Este SKU = **Mauve**. Não misturar cor de outro handle.
...
```
Exact LF PRO Essential Lips liquid lipstick shade Mauve, match reference image packaging 1:1,
frosted translucent tube with gold LF monogram and LF PRO lettering, glossy black cap,
doe-foot foam applicator tip saturated in color #9B4A5E, wide lipstick swatch smear behind
product matching shade #9B4A5E, pure white ecommerce cutout background, preserve logo, no redesign
```

### Studio hero scene (T1)

```
LF PRO Essential Lips Mauve exact packaging from reference on dark charcoal beauty studio
backdrop, soft key + gold rim light, product hero 3/4, micro push-in, 9:16, shade color
#9B4A5E visible on applicator/swatch, logo sharp, no face no hands
```

### Texture macro (T2)

```
Macro glossy liquid lipstick smear texture color #9B4A5E, soft matte setting finish, creamy
...
- Reference obrigatória: `assets/products/essential-lips-mauve/01.png`
