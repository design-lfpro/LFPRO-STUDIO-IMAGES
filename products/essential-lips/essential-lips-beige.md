...
Batom líquido matte Essential Lips, tom **Beige** — terracota-rosado claro, o mais neutro/claro da linha. Mesmo packaging da linha (ver [[_family|Essential Lips DNA]]); diferencial exclusivo = cor do líquido.

## Packaging (lock visual)

Ver `_family.md`. Lock:

1. Frasco em vidro/acrílico fosco translúcido, colunar, ombros retos — líquido Beige visível por trás do fosco
...
4. Aplicador doefoot preto com ponta em veludo/esponja afunilada, cor Beige
5. Sem texto do nome do tom impresso no frasco

**Assets:** `assets/products/essential-lips-beige/01.jpeg` (still de estúdio — fundo cinza, ver aviso de fundo em `_family.md`).

## Cor

**Descrição oficial (fonte: Direcionamento Time Essential Lips):** Tom nude, quente. Com toque caramelo.

### Leitura aproximada do still de estúdio (hex direcional)

| Parte | Cor / hex aprox |
|-------|-------------------|
| Líquido / swatch Beige | terracota-rosado claro, o mais neutro/claro da linha, aprox `#773639` |
...
- mais claro e neutro; não confundir com Malt (Malt é mais rosado-avermelhado, menos terroso)

## Notas para pipeline V1

- Packshot âncora: `assets/products/essential-lips-beige/01.jpeg`
