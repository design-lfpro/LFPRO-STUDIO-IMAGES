...
url: null
packshot: assets/products/essential-lips-wine/01.png
assets_dir: assets/products/essential-lips-wine/
...
Gloss labial líquido LF PRO Essential Lips — tom **Wine**. Ver DNA: [[_family|Essential Lips]].
...
|----------|------------|-----------|
| **Líquido** | `#5C1529` | vinho profundo / bordô escuro |

- **Subtom:** frio-profundo
...
```
LF PRO Essential Lips Wine lip gloss tube, slim cylindrical bullet-bottom tube, frosted translucent grey-tinted plastic body showing deep wine-burgundy liquid gloss (#5C1529), glossy piano-black cap approx 40 percent of tube length, thin silver ring at cap-body seam, warm gold interlocked LF monogram centered, LF PRO gold wordmark below monogram, seamless off-white #FAFAF8 studio, soft beauty lighting, three-quarter or straight-on packshot, photorealistic ecommerce product photo, exact tube shape and logo, no redesign
```

### T2 — texture macro

```
extreme close-up liquid lip gloss LF PRO Essential Lips Wine, deep wine-burgundy tone #5C1529, glossy mirror-like liquid sheen, no face, no hands, photorealistic beauty texture macro
```
