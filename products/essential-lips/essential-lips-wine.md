---
handle: essential-lips-wine
title: "Essential Lips Wine"
family: essential-lips
product_type: "Batom Líquido"
url: "https://lfpro.com.br/products/essential-lips-wine"
...
shade: Wine
lipstick_hex_approx: "#4A1027"
shopify_id: 10367202722072
shopify_sku: "12710"
price_brl: "69.90"
---
...
Essential Lips tom **Wine**. Mesma embalagem da família (tubo translúcido + aplicador doe-foot + tampa preta); diferencia-se pela **cor do líquido** visível no tubo, na ponta do aplicador e no swatch.

- Handle Shopify (previsto): `essential-lips-wine`
...
| Cor do produto | Tom vinho profundo, frio, com fundo ameixa. |
| Hex aproximado (observado no packshot oficial) | `#4A1027` |
...
Este SKU = **Wine**. Não misturar cor de outro handle.
...
```
Exact LF PRO Essential Lips liquid lipstick shade Wine, match reference image packaging 1:1,
frosted translucent tube with gold LF monogram and LF PRO lettering, glossy black cap,
doe-foot foam applicator tip saturated in color #4A1027, wide lipstick swatch smear behind
product matching shade #4A1027, pure white ecommerce cutout background, preserve logo, no redesign
```

### Studio hero scene (T1)

```
LF PRO Essential Lips Wine exact packaging from reference on dark charcoal beauty studio
backdrop, soft key + gold rim light, product hero 3/4, micro push-in, 9:16, shade color
#4A1027 visible on applicator/swatch, logo sharp, no face no hands
```

### Texture macro (T2)

```
Macro glossy liquid lipstick smear texture color #4A1027, soft matte setting finish, creamy
...
- Reference obrigatória: `assets/products/essential-lips-wine/01.png`
