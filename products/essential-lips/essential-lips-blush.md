...
url: "https://lfpro.com.br/products/essential-lips-blush"
...
shade: Blush
lipstick_hex_approx: "#C24A73"
shopify_id: 10367202361624
shopify_sku: "12706"
price_brl: "69.90"
---
...
Essential Lips tom **Blush**. Mesma embalagem da família (tubo translúcido + aplicador doe-foot + tampa preta); diferencia-se pela **cor do líquido** visível no tubo, na ponta do aplicador e no swatch.

- Handle Shopify (previsto): `essential-lips-blush`
...
| Cor do produto | Tom rosa médio, vibrante, com fundo levemente quente. |
| Hex aproximado (observado no packshot oficial) | `#C24A73` |
...
Este SKU = **Blush**. Não misturar cor de outro handle.
...
```
Exact LF PRO Essential Lips liquid lipstick shade Blush, match reference image packaging 1:1,
frosted translucent tube with gold LF monogram and LF PRO lettering, glossy black cap,
doe-foot foam applicator tip saturated in color #C24A73, wide lipstick swatch smear behind
product matching shade #C24A73, pure white ecommerce cutout background, preserve logo, no redesign
```

### Studio hero scene (T1)

```
LF PRO Essential Lips Blush exact packaging from reference on dark charcoal beauty studio
backdrop, soft key + gold rim light, product hero 3/4, micro push-in, 9:16, shade color
#C24A73 visible on applicator/swatch, logo sharp, no face no hands
```

### Texture macro (T2)

```
Macro glossy liquid lipstick smear texture color #C24A73, soft matte setting finish, creamy
...
- Reference obrigatória: `assets/products/essential-lips-blush/01.png`
