---
handle: po-soft-eye-medio
title: "Pó Soft Eye Médio"
family: po-soft-eye
product_type: "Pó"
url: "https://lfpro.com.br/products/po-soft-eye-medio"
preferred_tracks: [T1-product-hero, T2-texture-macro]
blocked_tracks: [T5-face-proof]
status: dna-v1
assets_local: assets/products/po-soft-eye-medio/
shade: Médio
powder_hex_approx: "#E0C8B0"
---
...
Pó Soft Eye tom **Médio**. Mesma embalagem da família; diferencia-se pela **cor do pó** no pote e no swatch.

- Handle Shopify: `po-soft-eye-medio`
- URL: https://lfpro.com.br/products/po-soft-eye-medio
...
| Pó / swatch | bege médio quente — verificar no 01 local (`#E0C8B0` aprox) |
| Nota | comparar com claro/escuro na ficha |
...
Este SKU = **Médio**. Não misturar cor de pó de outro handle.
...
```
Exact LF PRO Soft Eye loose powder shade Médio, match reference image packaging 1:1,
black lid gold LF monogram, gold perforated sifter, translucent jar filled with bege médio quente — verificar no 01 local,
black puff with gold LF PRO ribbon, powder swatch color #E0C8B0,
...
```
LF PRO Soft Eye Médio exact packaging from reference on dark charcoal beauty studio backdrop,
soft key + gold rim light, product hero 3/4, micro push-in, 9:16,
powder color #E0C8B0 visible if open, logo sharp, no face no hands
```

### Texture macro (T2)

```
Macro silky loose powder texture color #E0C8B0, fine soft particles, premium beauty soft focus,
...
- Reference obrigatória: `assets/products/po-soft-eye-medio/01.png` (ou extensão local)
